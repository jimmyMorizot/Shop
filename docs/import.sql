...
CREATE TABLE `product` (
  ...
  CONSTRAINT `product_ibfk_3` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(28,	'Test',	'Ceci est une description',	'http://',	5.00,	2,	1,	'2022-08-01 09:54:06',	NULL,	1,	NULL,	1);
